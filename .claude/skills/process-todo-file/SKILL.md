...
- **Stubs and TODOs in the code.** Grep the touched paths for `TODO`, `FIXME`, and any not-implemented marker introduced during the work. Each is either finished now, or gets an owning section and an XREF.
