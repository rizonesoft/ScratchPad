---
name: create-todo
description: Grok campaign runner. Author a whole new TODO file (frontmatter, Goal, Current state, Inputs, Outcome with Adjacency, Implementation Order, sections, Verification), then wire indexes, XREFs, and the plan. Use when add-todo routes here.
---

# Create TODO

Grok runner. Do not open `.claude/skills/create-todo`. Host rules: `.grok/rules/campaign-runner.md`.
...
Copy `.grok/skills/create-todo/todo-template.md` to `todo/<domain>/TODO-NN-<short-name>.md` and fill every part:
