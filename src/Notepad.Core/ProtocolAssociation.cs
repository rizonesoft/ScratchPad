...
// app registrar, driven through verbs. The scheme carries absolute paths as
// `scratchpad://<url-encoded absolute path>`; the launch parser maps
// well-formed links to files and ignores the rest.
