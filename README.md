...
- External review panel scripts (`review-batch`, `review-rounds`, `review-families`, `review-slices`): lens verdicts come from the mixed headless panel per `review-todo-section` until then.
