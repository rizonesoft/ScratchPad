...
**Test checkpoint:** `python3 scripts/todo-graph.py self-test` green at the new quoted count with a case per residual; each new fixture is mutation-proven, measured revert to failures: §13/§18/§19/§20/§21/§22 fail exactly their case under their own fix's revert; shared machinery fails together (anchored-to-substring reverts to §12/§15/§20; strip removed to §9/§14/§16/§17/§18/§21; naive toggle to §17/§18/§19/§21/§22). Cheaper substitute that fails: a fourth scan patch without the re-think, or fixtures that pass vacuously.
