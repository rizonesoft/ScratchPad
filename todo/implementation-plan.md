...
> **Progress:** **53 of 177 sections complete (30%).** Derived from the Implementation Order tables by `python3 scripts/todo-graph.py plan --sync` -- never edited by hand.
>
...
| [ ] | `D00 T01 §15` | First plan-review residuals                |  11   |
| [ ] | `D00 T01 §16` | Second plan-review residuals               |  16   |
