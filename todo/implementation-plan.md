...
> **Progress:** **36 of 159 sections complete (23%).** Derived from the Implementation Order tables by `python3 scripts/todo-graph.py plan --sync` -- never edited by hand.
>
...
| [ ] | `D01 T01 §30` | Locked-tab residue hardening                                        |   4   |
