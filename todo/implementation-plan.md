...
> **Progress:** **131 of 320 sections complete (41%).** Derived from the Implementation Order tables by `python3 scripts/todo-graph.py plan --sync` -- never edited by hand.
>
...
| [ ] | `D00 T02 §41` | Sibling sweep second residuals                            |  10   |
