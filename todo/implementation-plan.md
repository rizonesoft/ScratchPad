...
> **Progress:** **95 of 256 sections complete (37%).** Derived from the Implementation Order tables by `python3 scripts/todo-graph.py plan --sync` -- never edited by hand.
>
...
| [ ] | `D00 T02 §12` | Accelerator binding coverage sweep              |   3   |
| [ ] | `D00 T02 §13` | Backgrounding leak on the default leg           |   3   |
