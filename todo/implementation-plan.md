...
> **Progress:** **42 of 164 sections complete (26%).** Derived from the Implementation Order tables by `python3 scripts/todo-graph.py plan --sync` -- never edited by hand.
>
...
| [ ] | `D00 T02 §6` | Golden comparison deterministic on CI    |   7   |
...
| [ ] | `D01 T02 §13` | ScratchPad rename completion                                        |   6   |
