...
> **Progress:** **130 of 319 sections complete (41%).** Derived from the Implementation Order tables by `python3 scripts/todo-graph.py plan --sync` -- never edited by hand.
>
...
| [ ] | `D00 T02 §40` | Trend and telemetry second residuals                      |  18   |
