...
> **Progress:** **48 of 169 sections complete (28%).** Derived from the Implementation Order tables by `python3 scripts/todo-graph.py plan --sync` -- never edited by hand.
>
...
| [ ] | `D00 T02 §7`  | CI evidence capture pipeline             |   4   |
