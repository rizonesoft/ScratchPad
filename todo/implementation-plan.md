...
> **Progress:** **19 of 158 sections complete (12%).** Derived from the Implementation Order tables by `python3 scripts/todo-graph.py plan --sync` -- never edited by hand.
>
...
| [ ] | `D01 T01 §27` | Tab-strip chrome parity repair                                      |   7   |
