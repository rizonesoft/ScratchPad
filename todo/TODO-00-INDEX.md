...
- [00 Workspace] [TODO-10 Launch Harness Residuals](./00-workspace/TODO-10-launch-harness-residuals.md) -- the background launch harness's residuals: sibling sweep edges (overlap, containment, one verdict, load) and gate attribution (event-time identity, unknowns, privacy, tree ownership).
- [00 Workspace] [TODO-11 TODO Tooling Follow-Ups](./00-workspace/TODO-11-todo-tooling-follow-ups.md) -- TODO graph tooling follow-ups after TODO-01's section cap: refuse references to sections that do not exist.
