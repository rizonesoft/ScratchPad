...
- `Plan review:` -- the second-family round's completion marker: which family ran it and the filings it produced, `no findings`, or `outage: <rung>` when both runners failed. Required on stamps dated after 2026-09-18; earlier stamps predate the rule.
