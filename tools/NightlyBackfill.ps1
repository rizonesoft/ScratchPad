...
$result = [pscustomobject]@{
  ...
  provenance = [pscustomobject]@{
    ...
    'timings.interactive' = [pscustomobject]@{ source = "test-seconds in $(& $artifacts '*-full*.log')"; method = 'transcript-parse'; locator = (& $locateAll '*-full*.log' '(?i)Duration|test-seconds'); confidence = 'derived' }
